...
from src.bitcoin_scalper.core.data_fetcher import TimeFrame
from src.bitcoin_scalper.core.order_executor import OrderSide
from src.bitcoin_scalper.strategies.base_strategy import SignalType
from src.bitcoin_scalper.strategies.ema_crossover import EMACrossoverStrategy
...
def strategy(mock_data_fetcher, mock_order_executor):
    ...
    return EMACrossoverStrategy(
        ...
        params={"fast_period": 5, "slow_period": 10, "min_crossover_strength": 0.0001},
    )
...
def test_should_exit(strategy, sample_data):
    ...
    should_exit, signal = strategy.should_exit("BTCUSD", sample_data, OrderSide.BUY)
