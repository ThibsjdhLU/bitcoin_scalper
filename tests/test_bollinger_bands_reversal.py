...
class TestBollingerBandsReversalStrategy(unittest.TestCase):
    ...
    def test_validate_params(self):
        ...
        with self.assertRaises(ValueError):
            BollingerBandsReversalStrategy(
                ...
                timeframe=TimeFrame.M5,
                params={
                    'min_reversal_pct': 0  # doit être > 0
                }
            )
    ...
    def test_generate_trade_metadata(self):
        ...
        required_keys = [
            'signal_type', 'price', 'rsi', 'band_distance',
            'signal_strength', 'bb_upper', 'bb_middle', 'bb_lower'
        ]
