...
class TestMACDStrategy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data = pd.DataFrame({
            'open': [100, 102, 104, 103, 101, 99, 97, 96, 98, 100,
                    101, 103, 105, 104, 102, 100, 98, 97, 99, 101],
            'high': [102, 104, 105, 104, 102, 100, 98, 97, 99, 101,
                    102, 104, 106, 105, 103, 101, 99, 98, 100, 102],
            'low':  [99, 101, 103, 102, 100, 98, 96, 95, 97, 99,
                    100, 102, 104, 103, 101, 99, 97, 96, 98, 100],
            'close': [101, 103, 104, 102, 100, 98, 96, 97, 99, 100,
                     102, 104, 105, 103, 101, 99, 97, 98, 100, 101],
            'volume': [1000] * 20
        })
    ...
    def test_validate_params(self):
        ...
        with self.assertRaises(ValueError):
            MACDStrategy(
                ...
                timeframe=TimeFrame.M5,
                params={
                    'min_histogram_change': 0  # doit être > 0
                }
            )
        ...
        with self.assertRaises(ValueError):
            MACDStrategy(
                ...
                timeframe=TimeFrame.M5,
                params={
                    'divergence_lookback': 3  # doit être >= 5
                }
            )
    ...
    def test_detect_divergence(self):
        ...
        bull_div, bear_div = self.strategy._detect_divergence(
            price,
            macd,
            lookback=5
        )
    ...
    def test_generate_trade_metadata(self):
        ...
        required_keys = [
            'signal_type', 'price', 'macd', 'signal',
            'histogram', 'signal_strength', 'trend_ema'
        ]
