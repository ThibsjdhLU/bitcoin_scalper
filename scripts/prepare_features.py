...
from app.core.feature_engineering import FeatureEngineering # MODIFIED path
...
def prepare_dataset(input_path: str, output_path: str):
    ...
    cols_to_drop_before_export = ['<DATE>', '<TIME>']
    df_to_export = df.drop(columns=cols_to_drop_before_export, errors='ignore')

    # Select only relevant columns for the final CSV to keep it clean, or save all.
    # For now, saving all generated columns.
