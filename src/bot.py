    ...
    def start(self) -> None:
        ...
        while self.running:
            try:
                ...
                time.sleep(1)  # Réduit à 1 seconde pour des mises à jour plus fréquentes
    ...
    def run_bot(self):
        ...
        try:
            ...
            while True:
                try:
                    # Récupération des données de marché
                    market_data = self.exchange.get_market_data(self.config.get('mt5.symbol', 'BTCUSD'), self.config.get('mt5.timeframe', '1m'))
                    ...
                    if signal.get('buy') or signal.get('sell'):
                        ...
                        if self._check_daily_limits():
                            ...
                            if signal.get('buy'):
                                ...
                                self.exchange.close_position(self.exchange.get_open_positions(self.config.get('mt5.symbol', 'BTCUSD'))[0]['ticket'])
