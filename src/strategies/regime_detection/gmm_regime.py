"""
Module de détection des régimes de marché utilisant les mélanges de gaussiennes (GMM)
"""
...
class GMMRegimeDetector:
    """
    Classe pour la détection des régimes de marché utilisant les GMM
    """
    
    def __init__(self, n_regimes: int = 3, random_state: int = 42):
        """
        Initialise le détecteur de régimes GMM
    ...
    def fit(self, data: pd.DataFrame) -> None:
        """
        Entraîne le modèle GMM sur les données de prix
