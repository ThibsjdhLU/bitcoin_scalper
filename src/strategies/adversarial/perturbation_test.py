...
class PerturbationTest:
    ...
    def run_slippage_test(self, slippage_percentages=[0.5, 1.0, 2.0], duration_minutes=30):
        """
    ...
    def run_liquidity_test(self, volume_reductions=[0.5, 0.7, 0.9], duration_minutes=120):
        """
