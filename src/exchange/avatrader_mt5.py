...
class AvatraderMT5:
    ...
    def update_account_info(self) -> None:
        ...
        try:
            ...
            if current_time - self.last_account_info_log >= 300:  # 300 secondes = 5 minutes
    ...
    def place_order(self, symbol: str, order_type: str, volume: float, price: float = None) -> bool:
    ...
    def create_market_buy_order(self, symbol: str, amount: float, stop_loss: float = None, take_profit: float = None) -> Dict:
        """
    ...
    def create_market_sell_order(self, symbol: str, amount: float, stop_loss: float = None, take_profit: float = None) -> Dict:
        """
        ...
        for symbol, target_weight in target_weights.items():
            ...
            if current_position:
                ...
                if current_value < target_value:
                    ...
                    amount = (target_value - current_value) / mt5.symbol_info_tick(symbol).ask
                    self.create_market_buy_order(symbol, amount)
                elif current_value > target_value:
                    # Vente partielle
                    amount = (current_value - target_value) / mt5.symbol_info_tick(symbol).bid
    ...
    def get_account_info(self) -> Dict:
        ...
        try:
            ...
            if account_info is None:
                ...
                print(f"Erreur lors de la récupération des informations du compte: {error}")
                return {}
            ...
            print(f"Erreur lors de la récupération des informations du compte: {str(e)}")
            return {}
