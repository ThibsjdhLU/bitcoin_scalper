...
- 2024-06-12 – IA : Création d'une fiche d'installation détaillée pour MacOS (docs/source/installation_mac.rst), ajout à la table des matières Sphinx, et préparation du commit git pour faciliter l'installation du projet sur un nouveau Mac, conformément aux standards de documentation, sécurité et conteneurisation du projet.