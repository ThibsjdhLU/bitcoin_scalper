...
from app.core.data_ingestor import DataIngestor  # TODO: à instancier et lancer
...
from app.core.timescaledb_client import TimescaleDBClient  # TODO: à instancier pour stockage
from app.core.dvc_manager import DVCManager  # TODO: à utiliser pour versioning
from app.core.ml_pipeline import MLPipeline  # TODO: à charger pour prédiction ML
from app.core.backtesting import Backtester  # TODO: à intégrer pour reporting/backtest offline
from app.core.order_algos import execute_iceberg, execute_vwap  # TODO: à intégrer pour exécution avancée
